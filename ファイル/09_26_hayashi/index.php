...
<div class="container">
    ...
    <div class="jumbotron p-3 p-md-5 text-white rounded bg-dark">
        <div class="px-0 col-md-11">
            <h1 class="display-4 font-italic">Today Topic</h1>
            <p class="lead my-3">今日の一押しニュースを紹介テキストテキストテキスト</p>
            <p class="lead mb-0"><a href="login.php" class="text-white font-weight-bold">Continue reading...</a></p>
        </div>
    </div>
        ...
        <div class="col-md-6">
            ...
            <div class="card flex-md-row mb-4 box-shadow h-md-250">
                <div class="card-body d-flex flex-column align-items-start">
                    ...
                    <h3 class="mb-0">日産・ルノー連合、自動運転でグーグル陣営に参画</a>
                    </h3>
